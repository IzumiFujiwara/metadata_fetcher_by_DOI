...
- フォルダ source
  - カスタム関数とクエリをエクスポートしたファイルと、テキスト形式のファイルがあります。
...
## metadata_fetcher_by_DOI_ver_tsukuba.xlsm
metadata_fetcher_by_DOI_ver_tsukuba.xlsmについては、林先生の許可をいただいて筑波大学にて藤原いずみが開発しました。
使用方法については【使用方法】シートをご参照ください。

### データ取得元
- Unpaywall
- [日本の学協会の著作権ポリシー確認ツール](https://app.lib.shimane-u.ac.jp/policy_checker/scpj.php) Policy Checker (SCPJ) 